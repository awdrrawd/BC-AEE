...
import {CTRL_FRAME_STYLE} from '@/controllers/viewController';
...
export function ControlButton({active, label, icon, onClick}: {
  ...
  return <button
    className={`relative h-13 w-13 shrink-0 overflow-hidden rounded-lg border-0 bg-transparent p-0 ${active ? '[&_.aee-frame]:brightness-125 [&_.aee-frame]:hue-rotate-160' : 'hover:[&_.aee-frame]:brightness-125 hover:[&_.aee-frame]:hue-rotate-160'}`}
