...
import {movePartsPanel, togglePartsBrowser, togglePartsOpen} from '@/controllers/uiController';
...
export function PartsFloat({state}: { state: AeeState }) {
  ...
  return <FloatingPanel
    ...
    headerActions={<PartsBrowserButton open={state.partsBrowser.open} onClick={() => togglePartsBrowser()}/>}
