...
/*
try {
  const rawBcModGetModsInfo = bcModSdk.getModsInfo;
  bcModSdk.getModsInfo = () => rawBcModGetModsInfo().filter(mod => !mod.name.startsWith('.'));
} catch (err) {
    console.error('Failed to patch getModsInfo:', err);
}
*/
