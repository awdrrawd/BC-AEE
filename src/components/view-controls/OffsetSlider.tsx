export function OffsetSlider({label, min, max, step, value, display, onChange, onReset}: {label: string; min: number; max: number; step: number; value: number; display: string; onChange: (value: number) => void; onReset: () => void}) {
