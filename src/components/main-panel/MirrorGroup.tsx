  ...
  return <div className="mb-2">
    ...
    <div className="mb-1 grid grid-cols-2 gap-2">
      ...
      <div>
        ...
        <div className="flex gap-1">
          <MirrorButton active={!!layerOverride.MirrorCopy} label={t('mirrorH')} onClick={() => toggleMirror('MirrorCopy')}/>
          <MirrorButton active={!!layerOverride.MirrorCopyV} label={t('mirrorV')} onClick={() => toggleMirror('MirrorCopyV')}/>
        </div>
      </div>
    </div>
